...
import 'package:pocketminner/screens/wifi_password.dart';

class SSID extends StatefulWidget {
  SSID({Key? key}) : super(key: key);

  @override
  State<SSID> createState() => _SSIDState();
}
            ...
            MaterialButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => WifiPassword()));
                },
                child: Text(
                  'Rescan',
